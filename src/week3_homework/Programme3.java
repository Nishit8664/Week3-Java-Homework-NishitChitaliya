 ...
 * Input, Marks should between 0 to 100”) and find out calTotal, calPercentage and calResult.
 * If he is pass or fail on basis of calPercentage (pass>=35) and also give them calGrade if %> = 80 A+,
